    ...
    <div className="min-h-screen bg-background flex flex-col pattern-circles">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 max-w-md mx-auto w-full">
        ...
        <button
          ...
          className="w-full h-14 rounded-2xl border-2 border-border/50 bg-card flex items-center justify-center gap-3 font-bold text-foreground hover:bg-muted/50 hover:border-border active:scale-[0.98] transition-all mb-4 slide-up"
        >
